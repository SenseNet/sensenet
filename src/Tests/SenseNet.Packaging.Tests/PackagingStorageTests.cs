...
//        {
//            var dataProviderBackup = Providers.Instance.DataProvider;
//            Providers.Instance.DataProvider = new SqlProvider {DataProcedureFactory = Factory};
//            try
//            {
//                Procedures.Clear();
//                ExpectedCommandResult =
//                    new TestDataReader(new[] {"ComponentId", "ComponentVersion", "AcceptableVersion", "Description"},
//                        new[]
//                        {
//                            new object[]
//                                {"Component1", "0000000002.0000000000", "0000000001.0000000002", "description1"},
//                            new object[]
//                            {
//                                "Component2", "0000000003.0000000008", "0000000003.0000000007.0000000042",
//                                "description2"
//                            },
//                            new object[]
//                                {"Component3", "0000000006.0000000007", "0000000006.0000000005", "description3"},
//                        });
...
//            finally
//            {
//                Providers.Instance.DataProvider = dataProviderBackup;
//            }
//        }
...
//                ExpectedCommandResult = new TestDataReader(new[]
//                    {
//                        "Id", "PackageType", "ComponentId", "ComponentVersion",
...
//                        new object[]
//                        {
//                            1, "Install", "Component1", "0000000001.0000000002", releaseDate1, executionDate1,
//                            "Successful", null, "description1"
//                        },
//                        new object[]
//                        {
//                            2, "Install", "Component2", "0000000003.0000000007.0000000042", releaseDate2,
//                            executionDate2, "Successful", null, "description2"
//                        },
//                        new object[]
//                        {
//                            3, "Patch", "Component2", "0000000006.0000000005", releaseDate3, executionDate3,
//                            "Successful", null, "description3"
//                        },
//                    });
...
//                CheckParameter(parameters[5], "@ExecutionResult", DbType.AnsiString, 50,
//                    package.ExecutionResult.ToString());
//                CheckParameter(parameters[6], "@ExecutionError", DbType.String, 0, DBNull.Value);
//                CheckParameter(parameters[7], "@ComponentVersion", DbType.AnsiString, 50,
//                    EncodePackageVersion(package.ComponentVersion));
...
//                CheckParameter(parameters[6], "@ExecutionResult", DbType.AnsiString, 50,
//                    package.ExecutionResult.ToString());
//                CheckParameter(parameters[7], "@ExecutionError", DbType.String, 0, DBNull.Value);
//                CheckParameter(parameters[8], "@ComponentVersion", DbType.AnsiString, 50,
//                    EncodePackageVersion(package.ComponentVersion));
