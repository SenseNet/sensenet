...
namespace SenseNet.RestTester
{
    internal class BasicOperations : RestTestBase
    {
        ...
        {
            var root = Content.LoadAsync("/Root").GetAwaiter().GetResult();
        ...
        {
            var topLevelCollection = Content.LoadCollectionAsync("/Root").GetAwaiter().GetResult();
        ...
        public void CreateAndDeleteContent()
        {
            ...
            var loadedContent = Content.LoadAsync(contentId).GetAwaiter().GetResult();
            ...
            var deletedContent = Content.LoadAsync(contentId).GetAwaiter().GetResult();
        ...
        public void QueryContent()
        {
            ...
            var foundContents = Content.QueryForAdminAsync($"Name:'{contentName}'").GetAwaiter().GetResult().ToArray();
        ...
        public void UpdateAndQuery()
        {
            ...
            var foundContents = Content.QueryForAdminAsync($"DisplayName:'{displayNameBefore}'")
            ...
            var foundUpdatedContents = Content.QueryForAdminAsync($"DisplayName:'{displayNameAfter}'")
                .GetAwaiter().GetResult().ToArray();
