    ...
    public class VersionHistoryTests : TestBase
    {
        ...
        public void Versioning_History_LongHistory()
        {
            Test(() =>
            {
                ...
                test.CheckInAsync(CancellationToken.None).GetAwaiter().GetResult();
                ...
                test.UndoCheckOutAsync(CancellationToken.None).GetAwaiter().GetResult();
                ...
                test.SaveAsync(SavingMode.KeepVersion, CancellationToken.None).GetAwaiter().GetResult();
                ...
                test.SaveAsync(SavingMode.RaiseVersionAndLock, CancellationToken.None).GetAwaiter().GetResult();
                ...
                test.RejectAsync(CancellationToken.None).GetAwaiter().GetResult();
                ...
                test.ApproveAsync(CancellationToken.None).GetAwaiter().GetResult();
                ...
                test.PublishAsync(CancellationToken.None).GetAwaiter().GetResult();
