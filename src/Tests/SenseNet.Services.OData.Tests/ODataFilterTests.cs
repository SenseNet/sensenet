...
//        {
//            var entities = ODataGET<ODataEntities>("/OData.svc/Root/IMS/BuiltIn/Portal", "$filter=SenseNet.ContentRepository.Tests.OData.ODataFilterTestHelper/TestValue eq Name");
