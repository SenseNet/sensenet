...
";
        ...
        [TestMethod, TestCategory("Services")] public void UT_MsSql_UTDP_Node_InsertDraft_CSrv() { TestCase.UT_Node_InsertDraft(Cleanup); }
        ...
        [TestMethod] public void UT_MsSql_UTDP_RefProp_Insert() { TestCase.UT_RefProp_Insert(GetReferencesFromDb, Cleanup); }
        [TestMethod] public void UT_MsSql_UTDP_RefProp_Load() { TestCase.UT_RefProp_Load(GetReferencesFromDb, Cleanup); }
        [TestMethod] public void UT_MsSql_UTDP_RefProp_Update() { TestCase.UT_RefProp_Update(GetReferencesFromDb, Cleanup); }
        [TestMethod] public void UT_MsSql_UTDP_RefProp_Update3to0() { TestCase.UT_RefProp_Update3to0(GetReferencesFromDb, Cleanup); }
        [TestMethod] public void UT_MsSql_UTDP_RefProp_Update0to3() { TestCase.UT_RefProp_Update0to3(GetReferencesFromDb, Cleanup); }
        [TestMethod] public void UT_MsSql_UTDP_RefProp_NewVersionAndUpdate() { TestCase.UT_RefProp_NewVersionAndUpdate(GetReferencesFromDb, Cleanup); }

        [TestMethod] public void UT_MsSql_UTDP_RefProp_DeleteNode() { TestCase.UT_RefProp_DeleteNode(GetReferencesFromDb, Cleanup); }
        [TestMethod] public void UT_MsSql_UTDP_RefProp_DeleteVersion() { TestCase.UT_RefProp_DeleteVersion(GetReferencesFromDb, Cleanup); }
    }
}
