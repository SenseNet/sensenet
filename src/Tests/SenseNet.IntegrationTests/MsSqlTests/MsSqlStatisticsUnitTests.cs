...
namespace SenseNet.IntegrationTests.MsSqlTests
{
    ...
    public class MsSqlStatisticsUnitTests : IntegrationTest<MsSqlPlatform, StatisticsUnitTestCases>
    {
        ...
        [TestMethod]
        public async Task UT_MsSql_Stat_DataProvider_EnumerateData_ByRequestTime() { await TestCase.Stat_DataProvider_EnumerateData_ByRequestTime().ConfigureAwait(false); }
    }
}
