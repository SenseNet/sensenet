...
namespace SenseNet.IntegrationTests.InMemTests
{
    ...
    public class InMemStatisticsUnitTests : IntegrationTest<InMemPlatform, StatisticsUnitTestCases>
    {
        ...
        [TestMethod, TestCategory("Services")] public async Task UT_InMem_Stat_DataProvider_CleanupAggregations_CSrv() { await TestCase.Stat_DataProvider_CleanupAggregations().ConfigureAwait(false); }
