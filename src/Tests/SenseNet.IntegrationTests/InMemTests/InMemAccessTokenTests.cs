...
namespace SenseNet.IntegrationTests.InMemTests
{
    ...
    public class InMemAccessTokenTests : IntegrationTest<InMemPlatform, AccessTokenTestCases>
    {
        ...
        [TestMethod]
        public async Task IntT_InMem_AccessToken_GetOrAdd_WithFeature() { await TestCase.AccessToken_GetOrAdd_WithFeature().ConfigureAwait(false); }
        [TestMethod]
        public async Task IntT_InMem_AccessToken_GetOrAdd_WithContent() { await TestCase.AccessToken_GetOrAdd_WithContent().ConfigureAwait(false); }
        [TestMethod]
