...
{
    public class PgSqlSchemaWriter : SchemaWriter
    {
        private readonly string _connectionString;

        public PgSqlSchemaWriter(IOptions<ConnectionStringOptions> connectionStrings)
        {
        ...
        public override async STT.Task WriteSchemaAsync(RepositorySchemaData schema)
        {
            ...
            var installer = new PgSqlSchemaInstaller(_connectionString);
