...
#pragma warning restore 420
        ...
        {
            return new Term(LucObject.FieldName.NodeId, Lucene.Net.Util.NumericUtils.IntToPrefixCoded(nodeId));
        }
        ...
        {
            return VersionNumber.Parse(doc.Get(LucObject.FieldName.Version));
        }
        ...
        {
            return Int32.Parse(doc.Get(LucObject.FieldName.NodeId));
        }
