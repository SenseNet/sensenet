...
{
    internal class DefaultValueTemplateReplacer : TemplateReplacerBase
    {
        /// <summary>
        ...
        protected override string EvaluateExpression(object templateObject, string templateExpression, object templatingContext,
            string defaultUnit = null)
        {
            var evaluated = base.EvaluateExpression(templateObject, templateExpression, templatingContext, defaultUnit);

            // in case of a datetime value we have to remove the enclosing quotes placed by the base class
            if (templateObject is DateTime && evaluated != null)
