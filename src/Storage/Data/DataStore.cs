...
namespace SenseNet.ContentRepository.Storage.Data
{
    public static class DataStore
    {
        ...
        public static void SaveNode(NodeData nodeData, NodeSaveSettings settings)
        {
            SaveNodeAsync(nodeData, settings, CancellationToken.None).Wait();
        }
        ...
        public static async Task<NodeToken[]> LoadNodesAsync(NodeHead[] headArray, int[] versionIdArray)
        {
            ...
            return await DataProvider.LoadNodesAsync(headArray, versionIdArray);
        }
        public static NodeToken[] LoadNodes(NodeHead[] headArray, int[] versionIdArray)
        {
            return LoadNodesAsync(headArray, versionIdArray).Result;
        }
        ...
        public static void DeleteNode(int nodeId, long timestamp)
        {
            DataProvider.DeleteNodeAsync(nodeId, timestamp).Wait();
        }
        ...
        public static void MoveNode(int sourceNodeId, int targetNodeId, long sourceTimestamp, long targetTimestamp)
        {
            MoveNodeAsync(sourceNodeId, targetNodeId, sourceTimestamp, targetTimestamp).Wait();
        }
        ...
        public static NodeHead LoadNodeHead(string path)
        {
            return LoadNodeHeadAsync(path).Result;
        }
        public static async Task<NodeHead> LoadNodeHeadAsync(int nodeId)
        {
            return await DataProvider.LoadNodeHeadAsync(nodeId);
        }
        public static NodeHead LoadNodeHead(int nodeId)
        {
            return LoadNodeHeadAsync(nodeId).Result;
        }
        ...
        public static NodeHead LoadNodeHeadByVersionId(int versionId)
        {
            return LoadNodeHeadByVersionIdAsync(versionId).Result;
        }
        ...
        public static IEnumerable<NodeHead> LoadNodeHeads(IEnumerable<int> heads)
        {
            return LoadNodeHeadsAsync(heads).Result;
        }
