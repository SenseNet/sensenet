...
{
    //UNDONE:DB@@@@ Delete SnDataContext_OLD
    public abstract class SnDataContext_OLD<TConnection, TCommand, TParameter, TReader> : IDataPlatform<TConnection, TCommand, TParameter>, IDisposable
        ...
        where TReader : DbDataReader
    {
        ...
        protected SnDataContext_OLD(CancellationToken cancellationToken = default(CancellationToken))
        {
