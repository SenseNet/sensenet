...
{
    //UNDONE:DB@@@@ Delete MsSqlDataContext_OLD
    public class MsSqlDataContext_OLD : SnDataContext_OLD<SqlConnection, SqlCommand, SqlParameter, SqlDataReader>
    {
        private readonly string _connectionString;

        public MsSqlDataContext_OLD(CancellationToken cancellationToken = default(CancellationToken)) : base(cancellationToken) { }
        public MsSqlDataContext_OLD(string connectionString, CancellationToken cancellationToken = default(CancellationToken)) :
            base(cancellationToken)
        {
            //UNDONE:DB: TEST: not tested (packaging)
            _connectionString = connectionString;
        }
        public MsSqlDataContext_OLD(ConnectionInfo connectionInfo, CancellationToken cancellationToken = default(CancellationToken)) :
            base(cancellationToken)
        {
            //UNDONE:DB: TEST: not tested (packaging)
