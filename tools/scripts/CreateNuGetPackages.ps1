...
# nuget.exe push -Source "SenseNet" -ApiKey VSTS SenseNet.Services.7.0.0-beta4.nupkg
# nuget.exe push -Source "SenseNet" -ApiKey VSTS SenseNet.Services.Install.7.0.0-beta4.nupkg
