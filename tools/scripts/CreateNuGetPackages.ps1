...
nuget pack $srcPath\Tests\SenseNet.Tests\SenseNet.Tests.csproj -properties Configuration=Release -Exclude "Implementations\ContentTypeDefinitions.tt" -OutputDirectory $PSScriptRoot
