...
# ============================================================
#  stop-postgres.sh
#  Stops the sensenet PostgreSQL stack.
#
#  Usage:
#    ./stop-postgres.sh           # stop containers (keep data)
#    ./stop-postgres.sh --clean   # stop + remove volumes
#    ./stop-postgres.sh --help
# ============================================================
...
for arg in "$@"; do
  case "$arg" in
    ...
    --help|-h)
      ...
      echo ""
      echo "Stops the sensenet PostgreSQL stack."
      echo ""
      echo "Options:"
